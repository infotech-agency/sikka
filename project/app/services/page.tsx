...
import { FadeIn, StaggerContainer, StaggerItem } from '@/components/animations';
import { BASE_URL } from '@/utils/baseUrl';
import ServiceTileLink from '@/components/ServiceTileLink';
import { Compass, Building2, ClipboardList, Factory, Zap, Landmark, CheckCircle, ChevronRight } from 'lucide-react';
        ...
        <section className="py-20 bg-[#F8FAFC]">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-16">
              {services.map((service, index) => (
                <FadeIn key={service.id}>
                  <div id={service.id} className="grid lg:grid-cols-2 gap-8 items-center scroll-mt-28">
                    <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                      <img
                        src={service.image}
                        alt={service.title}
